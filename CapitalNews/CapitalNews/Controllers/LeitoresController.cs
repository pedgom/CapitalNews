...
namespace CapitalNews.Controllers
{
    public class LeitoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Fotolei,Username")] Leitores leitores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Fotolei,Username")] Leitores leitores)
        {
            if (id != leitores.Id)
            {
                return NotFound();
