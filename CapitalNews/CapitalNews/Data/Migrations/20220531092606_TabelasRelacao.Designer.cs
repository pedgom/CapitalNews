...
namespace CapitalNews.Data.Migrations
{
    ...
    [Migration("20220531092606_TabelasRelacao")]
    partial class TabelasRelacao
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FotografiasNoticias", b =>
                {
                    b.Property<int>("ListaFotografiasId")
                        .HasColumnType("int");

                    b.Property<int>("ListaNoticiasId")
                        .HasColumnType("int");

                    b.HasKey("ListaFotografiasId", "ListaNoticiasId");
            ...
            modelBuilder.Entity("FotografiasNoticias", b =>
                {
                    b.HasOne("CapitalNews.Models.Fotografias", null)
                        .WithMany()
                        .HasForeignKey("ListaFotografiasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CapitalNews.Models.Noticias", null)
                        .WithMany()
